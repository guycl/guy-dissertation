...
massRatio = (expandLowerMass / collapseLowerMass) * 0.75;
...
WriteMetaImage('complung_collapse_massgain25',collapseNew,hdr);
expand = expand - 1000;
WriteMetaImage('complung_expand_massgain25',expand,hdr);
