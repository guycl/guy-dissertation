...
massRatio = expandLowerMass / collapseLowerMass;
...
WriteMetaImage('complung_collapse_nomassloss',collapseNew,hdr);
expand = expand - 1000;
WriteMetaImage('complung_expand_nomassloss',expand,hdr);
